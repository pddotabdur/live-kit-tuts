...
9. تفاصيل العميل الحالي: الاسم: عبدالله، المبلغ المستحق: 1000 ريال."""
    ...
    async def on_enter(self):
        self.session.generate_reply(
            user_input="ابدئي المكالمة الآن باللهجة النجدية العامية إياكِ والتحدث بالفصحى. عرفي بنفسك وبمكتب توافق، ثم اذكري اسم العميل والمبلغ المستحق."
        )
...
async def entrypoint(ctx: JobContext):
    ...
    session = AgentSession(
        ...
        turn_detection="vad",        
        endpointing={
            "min_delay": 0.2,      # how soon after user stops we consider turn ended
