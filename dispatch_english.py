...
time.sleep(20)  # Pauses execution for exactly 10 seconds
...
async def main():
    ...
    try:
        ...
        print(f"🔊 English Agent securely dispatched! The agent is now joining the room and dialing {phone_number}.")
